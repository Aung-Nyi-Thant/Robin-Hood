...
const en = {
  ...
  sheriffHand: 'Sheriff’s hand', yourHand: 'Your hand', yourCards: 'Your cards', emptyHand: 'Your hand is empty this round.', buildOpening: 'BUILD YOUR OPENING HAND', refillSheriff: 'SHERIFF REFILL', cardsCount: '{count}/6 cards', drawMainInstruction: 'Draw one card at a time from the Royal Deck.', refillHand: 'Refill hand', discardTo: 'Discard to', selectOrSkip: 'Select cards or skip', left: 'Left', right: 'Right', needed: '{count} needed', upToFive: 'Up to 5 cards', drawOneAtTime: 'DRAW ONE AT A TIME', cardsNeeded: '{count} card(s) needed', choosePile: 'Choose a pile above, then draw.', declareAs: 'Declare as',
...
const th: Record<MessageKey, string> = {
  ...
  sheriffHand: 'ไพ่ของนายอำเภอ', yourHand: 'ไพ่ของคุณ', yourCards: 'ไพ่ของคุณ', emptyHand: 'รอบนี้คุณไม่มีไพ่ในมือ', buildOpening: 'สร้างมือเริ่มเกม', refillSheriff: 'นายอำเภอเติมไพ่', cardsCount: '{count}/6 ใบ', drawMainInstruction: 'จั่วทีละหนึ่งใบจากกองไพ่หลวง', refillHand: 'เติมไพ่ในมือ', discardTo: 'ทิ้งไปที่', selectOrSkip: 'เลือกไพ่หรือข้าม', left: 'ซ้าย', right: 'ขวา', needed: 'ต้องการอีก {count}', upToFive: 'สูงสุด 5 ใบ', drawOneAtTime: 'จั่วทีละหนึ่งใบ', cardsNeeded: 'ต้องการอีก {count} ใบ', choosePile: 'เลือกกองด้านบนแล้วจั่ว', declareAs: 'สำแดงเป็น',
